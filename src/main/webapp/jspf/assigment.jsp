...
<div id="main">
            ...
            <table class="table table-sm" id="table-info">
                ...
                <c:forEach var="assigment" items="${assigments}">
                    <tr>
                        ...
                        <td width="20"><a
                                href='<c:url value="/editassigment?id=${assigment.getId()}" />'
                                role="button" class="btn btn-outline-primary">
                            <img alt="Редактировать" src="images/icon-edit.png"></a>
                        </td> <td width="20"><a
                            href='<c:url value="/deleteassigment?id=${assigment.getId()}"/>'
    ...
    <section>
        <article>
            <h3>Добавить назначение прав</h3>
