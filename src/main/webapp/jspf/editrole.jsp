                ...
                <form method="POST" action="">
                    <div class="mb-3 row">
                        <div class="col-sm-7">
                            ...
                            <input type="text" name="idrole" class="form-control" id="staticIdvote" readonly value="${rolesEdit[0].getId()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <div class="col-sm-7">
                            <%--@declare id="permition"--%><label for="permition">Права</label>
                            <select name="permitionid" class="form-control">
                    ...
                    <div class="mb-3 row">
                        <div class="col-sm-7">
                            ...
                            <input type="text" name="namerole" class="form-control" id="staticIdvote" value="${rolesEdit[0].getNameRole()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <div class="col-sm-7">
                            <%--@declare id="descroption"--%><label for="descroption">Описание роли</label>
                            <input type="text" name="descroption" class="form-control" id="staticIdvote" value="${rolesEdit[0].getDescription()}"/>
                        </div>
                    </div>
                    <button type="submit"
                            class="btn btn-primary">Редактировать</button>
                    <a href='<c:url value="/editrole" />'
                       role="button"
