...
@WebServlet(name = "DeleteAssigmentServlet", value = "/deleteassigment")
public class DeleteAssigmentServlet extends HttpServlet {
    ...
    String delete_assigment = "DELETE FROM public.assigment  WHERE id = ?;";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if("/deleteassigment".equals(request.getServletPath())){
            request.getRequestDispatcher("/jspf/deleteassigment.jsp").forward(request, response);
        }
    }
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            try (PreparedStatement preparedStatement = conn.prepareStatement(delete_assigment)){
                preparedStatement.setLong(1, id);
            ...
            e.printStackTrace();
            getServletContext().getRequestDispatcher("/jspf/deleteassigment.jsp").forward(request, response);
